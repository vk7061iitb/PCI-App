...
class HistoryDataItem extends StatefulWidget {
  const HistoryDataItem({super.key, required this.file});
  final File file;
...
class _HistoryDataItemState extends State<HistoryDataItem> {
  ...
  Widget build(BuildContext context) {
    FileInfo getFileInfo(String input) {
      String fileName = input.split('_')[0];
      String dataType = 'AccData';
      String timeString = input.split('_')[2];
      String vehicleType = input.split('_').last.split('.csv').first;
